...
var en$1 = {
	"chatGPT.entry.name": "chatGPT",
	"chatGPT.entry.description": "Description of this extension"
};
var ja$1 = {
	"chatGPT.entry.name": "chatGPT",
	"chatGPT.entry.description": "拡張機能の説明"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	"ja-Hira": {
	"chatGPT.entry.name": "chatGPT",
	"chatGPT.entry.description": "かくちょうきのうのせつめい"
}
};
...
var entry = {
  get name() {
    return formatMessage$1({
      id: 'chatGPT.entry.name',
      default: 'chatGPT',
      description: 'name of the extension'
    });
  },
  extensionId: 'chatGPT',
  extensionURL: 'https://Qumacky.github.io/xcx-chatgpt/dist/chatGPT.mjs',
  ...
  helpLink: 'https://Qumacky.github.io/xcx-chatgpt/',
...
var en = {
	...
	"chatGPT.doIt": "do it [SCRIPT]"
};
var ja = {
	"chatGPT.name": "chatGPT",
	"chatGPT.doIt": "[SCRIPT] を実行する"
};
var translations = {
	en: en,
	ja: ja,
 ...
 * @type {string}
 */
var extensionURL = 'https://Qumacky.github.io/xcx-chatgpt/dist/chatGPT.mjs';
...
var ExtensionBlocks = /*#__PURE__*/function () {
  /**
   * Construct a set of blocks for chatGPT.
    ...
    value: function getInfo() {
      ...
      return {
        ...
        blocks: [{
          ...
          text: formatMessage({
            id: 'chatGPT.sendMessage',
            default: 'username [NAME] message [MESSAGE]',
            description: ''
          }),
          func: 'sendMessage',
          arguments: {
      ...
      var _sendMessage = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(args) {
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              username = cast.toString(args.NAME);
              log.log(username);
